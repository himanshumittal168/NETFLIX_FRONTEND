...
const TopMovies = () => {
  ...
  const addFavorites = async (movie) => {
    ...
    try {
      ...
      toast.error('Failed to add movie to wishlist. Please try again.');
    }
  }
  ...
  return (
    <div className="movie-list-container my-8">
      ...
      <div className="flex flex-row justify-between">
        <h2 className="text-2xl font-bold text-white mb-4 px-4 uppercase">Top rated</h2>
            ...
            >
              ...
              <div className="absolute inset-0 bg-black bg-opacity-0 group-hover/item:bg-opacity-50 transition-all duration-300 flex flex-col items-center justify-center opacity-0 group-hover/item:opacity-100">
                ...
                <div className='flex flex-row gap-3'>
                  ...
                  <button onClick={() => addFavorites(movie)} className="bg-gray-400 text-black py-1 px-3 rounded-xl text-sm font-semibold hover:text-pink-600 transition-colors duration-300">
                    Add to wishlist
                  </button>
                </div>
              </div>
