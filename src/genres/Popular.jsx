...
const PopularMovies = () => {
  ...
  const getMovies = async () => {
    try {
      setIsLoading(true);
      const response = await fetch("https://api.themoviedb.org/3/discover/movie?api_key=9c869b656bbcb8317a0c240b21095641");
      if (!response.ok) {
  ...
  return (
    <div className="movie-list-container my-8">
      ...
      <div className="flex flex-row justify-between">
        <h2 className="text-2xl font-bold text-white mb-4 px-4 uppercase">Popular</h2>
